...
module.exports.validateClothingItemId = celebrate({
  params: Joi.object().keys({
    clothingItemId: Joi.string().required().hex().length(24).messages({
      "string.empty": 'The "clothingItemId" field must be filled in',
      "string.hex": 'The "clothingItemId" field must be a hexadecimal value',
      "string.length": 'The "clothingItemId" field must be 24 characters long',
    }),
  }),
});
